// @ts-nocheck — orphan file from the upstream 2026 template; not currently
// imported at runtime in maneuver-core. Skips strict type checks until the
// demo-data orchestration is ported in alongside its dep web.
